@extends('layouts.app')
@section('title', ' تقرير الصرف المباشر ')
@section('style')
    <style>
        .header {
...
<div id='headers'>
    ...
    <div class="wrapper">
        <div>
            ...
            <p style='margin-top: -15px;' class="title"> تقرير الصرف المباشر </p>
        </div>
        <table id='table'>
            <thead>
                <tr>
...
@section('scripts')
    ...
    <script>
        ...
        columnText: function ( dt, idx, title ) {
            return (idx+1)+': '+title;
                ...
                },
                {
                    ...
                    title:'',
                    messageTop: '<img src="/images/load.png" style="position:relative;width:100%;" /><br>' +
                        html,
                    autoPrint: true,
                    exportOptions: {
                        columns: ":visible"
        ...
        var Pchannel = pusher.subscribe('direct');
