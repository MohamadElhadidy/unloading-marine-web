@extends('layouts.app')
@section('title', ' تقرير التحميل على رصيف الشحن ')
@section('style')
    <style>
        .header {
...
<div id='headers'>
    ...
    <div class="wrapper">
        <div>
            ...
            <p style='margin-top: -15px;' class="title"> تقرير التحميل على رصيف الشحن </p>
        </div>
        <table id='table'>
            <thead>
                <tr>
        ...
        var dt = $('#table').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    messageTop: '<img src="/images/move.png" style="position:relative;width:100%;" /><br>' +
                        html,
                    autoPrint: true,
                    title:'',
                    exportOptions: {
